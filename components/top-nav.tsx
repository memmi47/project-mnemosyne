  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-white/80 backdrop-blur-md">
      <nav className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 sm:px-5">
        <PwaNavLink href="/" className="flex items-center gap-2.5 text-base font-extrabold text-ink transition hover:text-primary">
          <span className="flex h-8 w-8 items-center justify-center rounded-btn bg-primary text-white text-xs font-black shadow-sm">M</span>
          <span className="tracking-tight">Mnemosyne</span>
        </PwaNavLink>

        <div className="flex items-center gap-1 sm:gap-2">
          <PwaNavLink
            href="/"
            className="flex items-center gap-2 rounded-btn px-2.5 py-2 text-sm font-semibold text-muted transition hover:bg-surface hover:text-ink"
          >
