      ...
      <div className="mt-8 rounded-card border border-border bg-white p-6 shadow-card animate-slide-up">
        ...
        <div className="mt-4 flex items-center gap-6">
          ...
          <div>
            ...
            <Link
              href="/session"
              className="mt-3 inline-flex h-10 items-center rounded-btn bg-primary px-5 text-sm font-bold text-white shadow-btn transition hover:shadow-btn-hover"
            >
              학습 시작
            </Link>
          </div>
...
function ProgressCard({
  ...
  return (
    <div
      className="card-enter rounded-card border border-border bg-white p-5 shadow-card"
  ...
  return (
    <div>
      ...
      <div className="mt-1.5 h-2.5 rounded-full bg-surface overflow-hidden">
        <div
          className={`h-2.5 rounded-full ${color} animate-progress-fill`}
          style={{ width: `${percent}%` }}
        />
      </div>
    </div>
